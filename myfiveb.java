...
public class myfiveb
{
    private static final int NUM_CLUSTERS = 3;    // Total clusters.
    private static final int TOTAL_DATA = 20;      // Total data points.
    
    private static final double SAMPLES[][] = new double[][] {{3.6,79},
    	{1.8,54},
    	{2.283,62},
    	{3.333,74},
    	{2.883,55},
   ...
   private static ArrayList<Data> dataSet = new ArrayList<Data>();
    ...
    private static void initialize()
    {
        ...
        centroids.add(new Centroid(4.7,83)); 
        
        
        
        for(int i=0;i<7;i++)
        {
        	Data newData = new Data(SAMPLES[i][0], SAMPLES[i][1]);
            dataSet.add(newData);
            newData.cluster(1);
        }
